...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ig6b6m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ig6b6m.containers.anotherwebservice.com/
...
```
git clone git@github.com:Siraj-Ahamed/container-ig6b6m.git
cd container-ig6b6m
```
...
```
docker attach container-ig6b6m
```
